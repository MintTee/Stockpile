## LLM have been used in the coding, testing, bug fixing and publishing of Stockpile.

- The server side logic and code has seen little AI use. I've coded almost everything by hand to the exception of some bug fixing in which LLMs have been used.
